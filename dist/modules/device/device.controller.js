...
deviceRouter.post("/register", (0, authentication_1.Authentication)(token_1.TokenType.access), (0, authorization_1.Authorization)({ accessRoles: [user_model_1.RoleType.admin] }), (0, validation_1.validation)(DV.registerDeviceSchema), device_service_1.default.registerDevice);
