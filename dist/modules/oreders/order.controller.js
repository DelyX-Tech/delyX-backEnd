...
orderRouter.patch("/:orderId/confirm", (0, authentication_1.Authentication)(token_1.TokenType.access), (0, validation_1.validation)(OV.confirmOrderSchema), order_service_1.default.confirmOrder);
orderRouter.patch("/dispatch", (0, authentication_1.Authentication)(), (0, validation_1.validation)(OV.dispatchOrderSchema), order_service_1.default.dispatchOrder);
...
orderRouter.post("/verify-otp", (0, validation_1.validation)(OV.verifyOtpSchema), order_service_1.default.verifyOtp);
